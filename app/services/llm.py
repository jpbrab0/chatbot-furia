...
from .db import storage_context
...
docs = reader.load_data("https://decided-tags-93.ezihost.net/")
...
prompt = f"""
    ...
    7. Perguntas sobre CS:GO/CS se referem agora à CS2
    8. Todas as lineups estao no contexto. Procure por Lineups ativas
    """
